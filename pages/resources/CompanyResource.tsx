    ...
    <div className="pt-32 min-h-screen bg-dark text-white">
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <div className="text-center mb-16">
            <span className="text-neon font-bold tracking-widest uppercase mb-2 block">{t.resourcesPage.pages.company.label}</span>
            <h1 className="text-4xl font-bold mb-4 text-white">{t.resourcesPage.sections.company}</h1>
            <p className="text-gray-300">{t.resourcesPage.pages.company.subtitle}</p>
        </div>
